    ...
    with gr.Tab("🧹 Manage & help"):
        ...
        with gr.Accordion("🔄 Update the app",
            ...
            gr.Markdown(
                ...
                "missing, checks that both model catalogs agree on their "
                "ids,\nand says whether the PyTorch engine is whole, absent, "
                "or — the case worth\ncatching — half installed. It downloads "
                "nothing and never touches your data.\n\n⚠️ **One trap worth knowing.** A Toolkit add-on is "
