    ...
    with gr.Tab("🧹 Gestion & aide"):
        ...
        with gr.Accordion("🎨 Onglets de génération (Flux.2 / Krea 2 / Boogu)",
            ...
            gr.Markdown(
                ...
                "**Chaos** = écart entre les propositions. La **ligne grise** "
                "sous les menus traduit ces chiffres en mots et dit ce que le "
                "bouton va faire *avant* que tu cliques.  \n"
        ...
        with gr.Accordion("🔧 Convertir en GGUF · 🧰 Toolkit", open=False):
            gr.Markdown(
                ...
                "*ESRGAN* (rapide, déterministe, 100 % GPU, interpole), "
                ...
                "l'original — « lab » convient presque toujours. *VAE par "
                "tuiles* ne sert qu'en cas de manque de mémoire sur une grande "
                "image : **ne monte pas la taille de tuile au-dessus de 512**, "
                "le VAE s'auto-attentionne sur la tuile entière et le coût "
                "explose en O(n²) ; descends plutôt à 256.  \n"
