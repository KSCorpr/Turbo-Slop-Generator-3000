    ...
    with gr.Tab("🧹 Gestion & aide"):
        ...
        with gr.Accordion("🖼️ Outpaint (étendre une image)", open=False):
            gr.Markdown(
                ...
                "zones sont pré-remplies par **effet miroir** des bords (départ "
                "plausible pour le modèle), le tout passe en **image-to-image**, "
                "puis **l'image d'origine est recollée intacte** par-dessus. "
                "C'est ce recollage qui garantit que la zone d'origine n'est "
                "**jamais** dégradée.\n\n"
                ...
                "proche du remplissage miroir (utile pour du ciel, du sable, une "
                "texture uniforme).  \n"
                "**Fondu de raccord** — largeur du dégradé à la jonction avec "
                "l'original. ~24 px efface la couture ; **0 = collage net** "
                "(l'original est préservé au pixel près jusqu'au bord).  \n"
